<template>
  <main id="Home-view">
    ...
    <input
      ...
      min="1960-01-01"
      max="2050-12-31"
      @change="changeInputDateHandler($event)"
    />
    ...
    <MsPopup
      id="popup"
      v-if="visiblePopup"
      @closePopup1="closedPopupIframe($event)"
    >
...
export default {
  ...
  methods: {
     ...
     * @param {dữ liệu truyền ra từ component con} event
     */
    closedPopupIframe(event) {
